...
export interface ApiDependencies {
  ...
  /** Runtime marking definitions (admin API for creating/deleting definitions + categories). */
  markingDefinitionStore?: MarkingDefinitionStore;
  ...
  /** Schema-driven transform expression service. */
  transformExpressionService?: TransformExpressionService;
