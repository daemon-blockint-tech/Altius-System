...
function pipelineDataOpsPaths(): Record<string, unknown> {
  ...
  return {
    ...
    '/api/v1/sql/jobs': { get: { tags: ['SQL'], summary: 'List SQL query jobs', operationId: 'listSqlJobs', responses: { '200': { description: 'Jobs list', content: jsonObject }, '401': unauthorized } } },
    '/api/v1/sql/jobs/{id}': { get: { tags: ['SQL'], summary: 'Get a SQL query job', operationId: 'getSqlJob', parameters: [idParam], responses: { '200': { description: 'Job', content: jsonObject }, '401': unauthorized, '404': { description: 'Not found' } } } },
    '/api/v1/sql/analytics': { post: { tags: ['SQL'], summary: 'Submit an analytics SQL query', operationId: 'querySqlAnalytics', requestBody: { required: true, content: jsonObject }, responses: { '200': { description: 'Query result', content: jsonObject }, '401': unauthorized } } },
    '/api/v1/pipelines': {
