...
Hide sidebar
  ...
  * [Overview](</docs/foundry/architecture-center/overview/>)
  * [AIP, Foundry, and Apollo](</docs/foundry/architecture-center/platforms/>)
  * [The Ontology system](</docs/foundry/architecture-center/ontology-system/>)
  * [The Multimodal Data Plane](</docs/foundry/architecture-center/multimodal-data-plane/>)
  * [Interoperability](</docs/foundry/architecture-center/interoperability/>)
  * [The Rubix substrate](</docs/foundry/architecture-center/rubix/>)
  * [AIP architecture overview](</docs/foundry/architecture-center/aip-architecture/>)



[Architecture center](</docs/foundry/architecture-center/overview/>)[The Ontology system](</docs/foundry/architecture-center/ontology-system/>)

# [](<#the-ontology-system>)The Ontology system
...
## [](<#how-the-ontology-models-decisions>)How the Ontology models decisions
...
### [](<#ontology-example-medical-manufacturing>)Ontology example: Medical manufacturing
...
## [](<#the-ontology-language-ontology-engine-and-ontology-toolchain>)The Ontology Language, Ontology Engine, and Ontology Toolchain
...
## [](<#a-digital-representation-of-your-world>)A digital representation of your world
...
[←PREVIOUSAIP, Foundry, and Apollo](</docs/foundry/architecture-center/platforms/>)

[NEXTThe Multimodal Data Plane→](</docs/foundry/architecture-center/multimodal-data-plane/>)
