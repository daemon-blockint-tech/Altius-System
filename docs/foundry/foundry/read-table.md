...
Version 1.0Version 2.0
  ...
  * [Validate Action](</docs/foundry/api/v1/ontology-resources/actions/validate-action/>)
  * Query Types

  * [Query Type basics](</docs/foundry/api/v1/ontology-resources/query-types/query-type-basics/>)
  * [List Query Types](</docs/foundry/api/v1/ontology-resources/query-types/list-query-types/>)
  * [Get Query Type](</docs/foundry/api/v1/ontology-resources/query-types/get-query-type/>)
  * Queries

  * [Query basics](</docs/foundry/api/v1/ontology-resources/queries/query-basics/>)
  * [Execute Query](</docs/foundry/api/v1/ontology-resources/queries/execute-query/>)
  * Objects

  * [Ontology Object basics](</docs/foundry/api/v1/ontology-resources/objects/ontology-object-basics/>)
  * [List Objects](</docs/foundry/api/v1/ontology-resources/objects/list-objects/>)
  * [Get Object](</docs/foundry/api/v1/ontology-resources/objects/get-object/>)
  * [List Linked Objects](</docs/foundry/api/v1/ontology-resources/objects/list-linked-objects/>)
  * [Get Linked Object](</docs/foundry/api/v1/ontology-resources/objects/get-linked-object/>)
  * [Search Objects](</docs/foundry/api/v1/ontology-resources/objects/search-objects/>)
  * [Aggregate Objects](</docs/foundry/api/v1/ontology-resources/objects/aggregate-objects/>)
  * [Search Objects Details](</docs/foundry/api/v1/ontology-resources/objects/search/>)
  * [Aggregate Objects Details](</docs/foundry/api/v1/ontology-resources/objects/aggregate/>)
  * Attachments

  * [Attachment basics](</docs/foundry/api/v1/ontology-resources/attachments/attachment-basics/>)
  * [Upload Attachment](</docs/foundry/api/v1/ontology-resources/attachments/upload-attachment/>)
  * [Get Attachment Content](</docs/foundry/api/v1/ontology-resources/attachments/get-attachment-content/>)
  * [Get Attachment](</docs/foundry/api/v1/ontology-resources/attachments/get-attachment/>)
  * * * *
...
cURLPythonJavaJavaScriptPowershell

Copied!

`1 2 3 ``curl \ \t-H "Authorization: Bearer $TOKEN" \ "https://$HOSTNAME/api/v1/datasets/ri.foundry.main.dataset.c26f11c8-cdb3-4f44-9f5d-9816ea1c82da/readTable?branchId=master&startTransactionRid=ri.foundry.main.transaction.0a0207cb-26b7-415b-bc80-66a3aa3933f4&endTransactionRid=ri.foundry.main.transaction.0a0207cb-26b7-415b-bc80-66a3aa3933f4&format=CSV"`

## [](<#error-responses>)Error responses

Error Name|   
---|---  
`InvalidParameterCombination`| **Error Code**| `INVALID_ARGUMENT`  
**Status Code**|  400  
...
`SchemaNotFound`| **Error Code**| `NOT_FOUND`  
**Status Code**|  404  
**Description**|  A schema could not be found for the given dataset and branch, or the client token does not have access to it.  
**Parameters**| `datasetRid, branchId, transactionRid`  
`ReadTablePermissionDenied`| **Error Code**| `PERMISSION_DENIED`  
**Status Code**|  403  
...
**Parameters**| `datasetRid`  
`DatasetReadNotSupported`| **Error Code**| `INVALID_ARGUMENT`  
**Status Code**|  400  
**Description**|  The dataset does not support being read.  
**Parameters**| `datasetRid`  
  
See [Errors](</docs/foundry/api/general/overview/errors/>) for a general overview of errors in the platform.
