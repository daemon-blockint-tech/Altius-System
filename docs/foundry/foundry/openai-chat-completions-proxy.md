---
source_url: https://www.palantir.com/docs/foundry/api/v2/llm-apis/models/openai-chat-completions-proxy
---
...
# [](<#openai-chat-completions-proxy>)OpenAI Chat Completions (Proxy)
...
## [](<#aip-integration-and-data-governance>)AIP integration and data governance
...
## Contents
  ...
  * [OpenAI Chat Completions (Proxy)](<#open-ai-chat-completions-proxy>)
    * [Headers](<#headers>)
    * [Request format](<#request-format>)
    * [AIP integration and data governance](<#aip-integration-and-data-governance>)
    * [Examples](<#examples>)
