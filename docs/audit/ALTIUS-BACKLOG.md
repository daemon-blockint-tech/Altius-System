...
These 21 changes were committed AFTER the gradings below were taken, so the evidence on the rows they touch is stale. They are commits, not re-measurements — a row listed here has **not** been re-graded, only invalidated. Re-doing landed work is the most expensive mistake available here, so read the commit before you start.
...
> ⚠ **Evidence below is STALE.** Landed since it was taken: `function-rest` (`8fc01fc`), `computed-in-lists` (`6e8b4ba`). Re-read the code before doing anything.
...
> ⚠ **Evidence below is STALE.** Landed since it was taken: `subscription-filter` (`a065ac1`). Re-read the code before doing anything.
...
> ⚠ **Evidence below is STALE.** Landed since it was taken: `effect-value-types` (`97f468f`). Re-read the code before doing anything.
...
> ⚠ **Evidence below is STALE.** Landed since it was taken: `function-authz` (`34f540f`), `function-sandbox` (`81e0361`), `function-rest` (`8fc01fc`). Re-read the code before doing anything.
...
> ⚠ **Evidence below is STALE.** Landed since it was taken: `function-authz` (`34f540f`), `function-audit` (`6f94194`), `function-sandbox` (`81e0361`). Re-read the code before doing anything.
...
> ⚠ **Evidence below is STALE.** Landed since it was taken: `function-audit` (`6f94194`). Re-read the code before doing anything.
