...
> ⚠ **Evidence below is STALE.** Landed since it was taken: `function-rest` (`8fc01fc`), `computed-in-lists` (`6e8b4ba`), `function-ontology-access` (`2deda98, a64911f, d5ce1c1`). Re-read the code before doing anything.
...
> ⚠ **Evidence below is STALE.** Landed since it was taken: `subscription-filter` (`a065ac1`), `subscription-tenant-isolation` (`c34a3cd`). Re-read the code before doing anything.
...
> ⚠ **Evidence below is STALE.** Landed since it was taken: `version-exposed` (`a065ac1`). Re-read the code before doing anything.
...
> ⚠ **Evidence below is STALE.** Landed since it was taken: `self-link-support` (pending commit). Re-read the code before doing anything.
...
> ⚠ **Evidence below is STALE.** Landed since it was taken: `effect-value-types` (`97f468f`), `param-forgery` (`c34a3cd`). Re-read the code before doing anything.
...
> ⚠ **Evidence below is STALE.** Landed since it was taken: `mcp-auth-bypass` (`a065ac1`). Re-read the code before doing anything.
...
> ⚠ **Evidence below is STALE.** Landed since it was taken: `rest-connector` (`4bed9d3`). Re-read the code before doing anything.
...
> ⚠ **Evidence below is STALE.** Landed since it was taken: `computed-in-lists` (`6e8b4ba`). Re-read the code before doing anything.
...
> ⚠ **Evidence below is STALE.** Landed since it was taken: `function-authz` (`34f540f`), `function-sandbox` (`81e0361`), `function-rest` (`8fc01fc`), `function-ontology-access` (`2deda98, a64911f, d5ce1c1`). Re-read the code before doing anything.
...
> ⚠ **Evidence below is STALE.** Landed since it was taken: `audit-tenant` (`ce7ae32`). Re-read the code before doing anything.
...
> ⚠ **Evidence below is STALE.** Landed since it was taken: `function-authz` (`34f540f`). Re-read the code before doing anything.
...
> ⚠ **Evidence below is STALE.** Landed since it was taken: `function-authz` (`34f540f`), `function-audit` (`6f94194`), `function-sandbox` (`81e0361`), `function-ontology-access` (`2deda98, a64911f, d5ce1c1`). Re-read the code before doing anything.
...
> ⚠ **Evidence below is STALE.** Landed since it was taken: `interfaces-polymorphic` (`44f5951`). Re-read the code before doing anything.
...
> ⚠ **Evidence below is STALE.** Landed since it was taken: `mcp-auth-bypass` (`a065ac1`), `mcp-filter-guard` (`a065ac1`). Re-read the code before doing anything.
...
> ⚠ **Evidence below is STALE.** Landed since it was taken: `primary-field-filter` (`f8146df`). Re-read the code before doing anything.
...
> ⚠ **Evidence below is STALE.** Landed since it was taken: `update-delete-mutations` (`11a6510`). Re-read the code before doing anything.
...
> ⚠ **Evidence below is STALE.** Landed since it was taken: `consent-primary-id` (`a065ac1`). Re-read the code before doing anything.
...
> ⚠ **Evidence below is STALE.** Landed since it was taken: `mcp-filter-guard` (`a065ac1`), `fga-per-tenant` (`379e5be, 6e8b4ba, 36b5b6d`). Re-read the code before doing anything.
...
> ⚠ **Evidence below is STALE.** Landed since it was taken: `age-write-loss` (`c86e3f7`). Re-read the code before doing anything.
