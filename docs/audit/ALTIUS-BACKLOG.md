...
Generated from code-verification passes, most recently 18 Aug 2026. **189** capabilities graded: **16 full, 95 partial, 76 absent** (work items; 2 additional capabilities were already `full` and are not listed as work items — total 18 `full`).
